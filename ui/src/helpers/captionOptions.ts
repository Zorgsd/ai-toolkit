...
export const captionerTypes: CaptionOption[] = [
    ...
    },
    {
        ...
        name_or_path_options: [
            ...
            { value: 'HuggingFaceM4/Florence-2-DocVQA', label: 'HuggingFaceM4/Florence-2-DocVQA' },
            { value: 'thwri/CogFlorence-2.1-Large', label: 'thwri/CogFlorence-2.1-Large' },
            { value: 'thwri/CogFlorence-2.2-Large', label: 'thwri/CogFlorence-2.2-Large' },
            { value: 'gokaygokay/Florence-2-SD3-Captioner', label: 'gokaygokay/Florence-2-SD3-Captioner' },
            { value: 'gokaygokay/Florence-2-Flux-Large', label: 'gokaygokay/Florence-2-Flux-Large' },
            { value: 'MiaoshouAI/Florence-2-base-PromptGen-v1.5', label: 'MiaoshouAI/Florence-2-base-PromptGen-v1.5' },
            { value: 'MiaoshouAI/Florence-2-large-PromptGen-v1.5', label: 'MiaoshouAI/Florence-2-large-PromptGen-v1.5' },
            { value: 'MiaoshouAI/Florence-2-base-PromptGen-v2.0', label: 'MiaoshouAI/Florence-2-base-PromptGen-v2.0' },
            { value: 'MiaoshouAI/Florence-2-large-PromptGen-v2.0', label: 'MiaoshouAI/Florence-2-large-PromptGen-v2.0' },
            { value: 'PJMixers-Images/Florence-2-base-Castollux-v0.5', label: 'PJMixers-Images/Florence-2-base-Castollux-v0.5' },
        ],
        additionalSections: [
            'caption.caption_prompt',
            'caption.max_res',
